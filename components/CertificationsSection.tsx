          ...
          {CERTIFICATIONS.map((cert) => {
            ...
            return (
              <a
                ...
                className="card-glass rounded-xl p-5 transition-all duration-300 group flex flex-col"
                onMouseEnter={(e) =>
              ...
              >
                ...
                <h3 className="font-semibold text-sm text-[var(--text-primary)] leading-snug mb-1 flex-1">
                  {cert.name}
                </h3>
                <p className="text-xs font-mono mt-auto pt-2" style={{ color: s.label }}>
                  {cert.issuer}
                </p>
              </a>
            );
